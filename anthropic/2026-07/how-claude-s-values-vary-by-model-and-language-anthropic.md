...
published_at: 2026-07-13T17:00:08.407Z
crawled_at: 2026-07-14T02:00:43.057Z
word_count: 4051
reading_time_minutes: 21
tags: [claude, reasoning, agents, infrastructure, evaluation, research, product, enterprise, coding]
---
...
We compute how Claude’s value profile differs across the 20 most common languages on [Claude.ai](http://claude.ai/redirect/website.v1.165b5f60-c99c-466a-8279-ebaf74a1fde6) using the same method as the previous section. Below, we plot Claude's value profile across the top languages on the Claude platform, beginning with the languages where Claude's expressed values diverge the most.
...
3. These four axes account for 15% of the total variance in values across conversations _after_ controlling for the conversation task, topic, and user-expressed values.
