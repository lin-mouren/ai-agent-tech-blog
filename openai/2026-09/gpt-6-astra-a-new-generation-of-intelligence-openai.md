...
published_at: 2026-09-04T01:00:02.351Z
crawled_at: 2026-09-04T02:00:29.778Z
word_count: 5342
reading_time_minutes: 27
tags: [gpt, claude, gemini, reasoning, safety, agents, infrastructure, evaluation, api, research]
---
...
Launch film from OpenAI on Vimeo
...
$0$20$40$60$8020%30%40%50%60%70%Resolution rateAPI CostGPT-6 AstraGPT-5.6 SolClaude Fable 5.1Claude Fable 5Claude Opus 5
...
GPT-5.6 SolGPT-6 Astra0%10%20%30%40%50%60%Successful exploit rate0.0%48.2%
...
_BenchCAD tests whether models can reconstruct 3D objects from multi-view renders by generating CAD code. With tools, GPT‑6 Astra reaches a new high in the comparison shown, achieving a 95.9% geometric-overlap score, versus 83.3% for GPT‑5.6 Sol and 84.3% reported for Claude Fable 5.1._ [5](https://openai.com/index/gpt-6-astra/#citation-bottom-5) _Estimated API cost is approximately 43% lower than Sol and 86% lower than Fable 5.1 in the configurations shown._
...
SALTWATER CIRCUIT · ROUND 01

TIDALRUSH✦

PARADISE GRAND PRIX

WEBGL COULD NOT START — CHECK THE CONSOLE
...
A LITTLE SALT. A LOT OF SPEED.

8TH/ 8

PARADISE GP **00:00.000**
...
SUNBREAK COVE · FINAL RESULT

**1** ST

## COVE CHAMPION!

TOTAL TIME **00:00.000**
...
**PAUSED** PRESS P OR ESC TO GET BACK OUT THERE
...
GPT‑6 Astra is a major advance for scientific discovery, mathematics, and health. Today, we’re sharing two further results on the gaps between prime numbers.[9](https://openai.com/index/gpt-6-astra/#citation-bottom-9), [10](https://openai.com/index/gpt-6-astra/#citation-bottom-10)
...
As we discussed in our [safety update](https://openai.com/index/path-to-astra/), Astra is a significant jump in cyber capabilities and meets the [Critical threshold⁠(opens in a new window)](https://www.google.com/url?q=https://openai.com/index/path-to-astra/&sa=D&source=docs&ust=1788394134604543&usg=AOvVaw0evbJw3ljnuix36JTZDiwA) in cybersecurity under our [Preparedness Framework](https://openai.com/index/updating-our-preparedness-framework/). Its ability to identify and develop zero-day exploits can help defenders find and patch weaknesses, but it also creates a need for stronger safeguards. To understand how far these capabilities extend, we ran Astra on internal and third-party expert evaluations.

We first tested the model without production safeguards on ExploitBench and ExploitGym, which evaluate whether models can turn known software vulnerabilities into working exploits. On ExploitBench, Astra achieved a perfect score of 100%, compared with 78.5% for GPT‑5.6 Sol, our previous frontier cyber-capable model. On ExploitGym, Astra reached a 42.4% success rate, compared with 30.3% for GPT‑5.6 Sol, while using substantially fewer output tokens.[13](https://openai.com/index/gpt-6-astra/#citation-bottom-13)

Given concerns that exposure to historical software vulnerabilities may have affected benchmark results, we also evaluated Astra on two novel benchmarks. For one, we built an internal “ExploitBench (June–August 2026)” evaluation to test exploit development using vulnerabilities from the previous three months.[14](https://openai.com/index/gpt-6-astra/#citation-bottom-14) Astra achieved substantially higher arbitrary code-execution rates than GPT‑5.6 Sol on this dataset while using far fewer output tokens. During the evaluation, Astra even discovered and used two previously unknown zero-day vulnerabilities. We are disclosing both vulnerabilities to their maintainers.

We also tested Astra on SRE-Bench[15](https://openai.com/index/gpt-6-astra/#citation-bottom-15), a benchmark that measures whether models can reverse engineer software binaries to understand its core logic without access to raw source code. Astra solved 88.0% of tasks in a single attempt and 99.2% within four attempts, compared with 55.9% and 68.7% for GPT‑5.6 Sol, respectively.
...
Alignment training is core to our approach to deployment. As additional layer of defenses, we also build system safeguards like Codex [Auto-review⁠(opens in a new window)](https://alignment.openai.com/auto-review/) and monitoring agents’ reasoning and actions to help detect and contain unsafe behavior. As described in our [safety update⁠](https://openai.com/index/path-to-astra/), we are also deploying misalignment monitoring in production for Astra-class models in order to have visibility into misalignment, and help contain its worst instances. These safeguards resemble our monitoring for internal deployments and involve a system of classifiers which check the model’s reasoning and actions for unauthorized behavior and automatically stop potentially unauthorized activity.
...
|     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- |
| **Computer Use** | **GPT‑6 Astra** | **GPT‑5.6 Sol** [**2** ⁠(opens in a new window)](https://openai-dotcom-preview.vercel.app/index/gpt-6-astra/#citation-bottom-2) | **Claude Fable 5.1** | **Claude Fable 5** | **Claude Opus 5** | **Gemini 3.8 Flash** |
| Agents' Last Exam | 59.3% | 53.6% | - | 48.7% | 55.5% | - |
| OSWorld 2.0 (v2026.08.08, offline set, partial score) | 72.6% | 65.7% | - | - | 70.2% [3⁠(opens in a new window)](https://openai-dotcom-preview.vercel.app/index/gpt-6-astra/#citation-bottom-3) | - |
| ScreenSpot-Pro (no tools) | 92.7% | 76.9% | - | 87.3% [16⁠(opens in a new window)](https://openai-dotcom-preview.vercel.app/index/gpt-6-astra/#citation-bottom-16) | - | - |
...
| BenchCAD | 95.9% | 83.3% | 84.3% [4](https://openai.com/index/gpt-6-astra/#citation-bottom-4) | 67.5%[4](https://openai.com/index/gpt-6-astra/#citation-bottom-4) | 82.1% [4](https://openai.com/index/gpt-6-astra/#citation-bottom-4) | - |
...
| FrontierCode 1.1 Extended (score) | 64.5% [7](https://openai.com/index/gpt-6-astra/#citation-bottom-7) | 60.6% | 63.6% | 64.9% | 63.6% | 56.3% |
| FrontierCode 1.1 Main (score) | 53.3% [7](https://openai.com/index/gpt-6-astra/#citation-bottom-7) | 47.5% | 50.9% | 53.5% | 53.4% | 43.6% |
...
| HealthBench Professional (length-adjusted) | 63.4% | 60.5% | 58.1% [10](https://openai.com/index/gpt-6-astra/#citation-bottom-10) | 60.9% [10](https://openai.com/index/gpt-6-astra/#citation-bottom-10) | 56.4% [10](https://openai.com/index/gpt-6-astra/#citation-bottom-10) | 52.1% |
...
| Exploit Gym | 42.4% [12](https://openai.com/index/gpt-6-astra/#citation-bottom-12) | 30.3% [12](https://openai.com/index/gpt-6-astra/#citation-bottom-12) | 30.4% [16](https://openai.com/index/gpt-6-astra/#citation-bottom-16) | 28.4%[16](https://openai.com/index/gpt-6-astra/#citation-bottom-16) | 22.0%[16](https://openai.com/index/gpt-6-astra/#citation-bottom-16) |  |
...
01. 1
    ...
    On ARC-AGI-3, GPT-6 Astra was run with [our responses API harness⁠](https://openai.com/index/how-two-settings-tripled-our-arc-agi-3-scores/), which changes two settings to better match real-world performance. The changes do not specifically target ARC-AGI-3.[Scroll to citation 1 reference](https://openai.com/index/gpt-6-astra/#citation-top-1)

02. 2


    GPT-5.6 Sol refers to the version available in our API, ChatGPT Codex, and ChatGPT Work. [The version in ChatGPT Chat is slightly different.⁠](https://openai.com/index/improving-gpt-5-6-sol-in-chatgpt/)[Scroll to citation 2 reference](https://openai.com/index/gpt-6-astra/#citation-top-2)

03. 3


    OSWorld V2-Offline is a subset of the original OSWorld V2 that works without internet access. Claude model performance on OSWorld-V2 Offline was reproduced by an independent third-party. On OSWorld 2.0, the scores for Claude use the official settings, and not the modified tasks and modified grading from the Fable 5.1 System Card.[Scroll to citation 3 reference](https://openai.com/index/gpt-6-astra/#citation-top-3)

04. 5


    On BenchCAD, Claude's scores reflect 3 modifications to the eval, detailed in the [Fable 5.1 System Card⁠(opens in a new window)](https://www-cdn.anthropic.com/0339e6a7c5c7b87f5c07798616dc32c215d14235/Claude%20Fable%205.1%20&%20Claude%20Mythos%205.1%20System%20Card.pdf).[Scroll to citation 5 reference](https://openai.com/index/gpt-6-astra/#citation-top-5)

05. 6


    Guang Yang, Victoria Ebert, Nazif Tamer, Brian Siyuan Zheng, Luiza Pozzobon, and Noah A. Smith. “ [LEGATO: Large-scale End-to-end Generalizable Approach to Typeset OMR⁠(opens in a new window)](https://arxiv.org/abs/2506.19065).” arXiv:2506.19065, 2025.[Scroll to citation 6 reference](https://openai.com/index/gpt-6-astra/#citation-top-6)

06. 7


    Mark R. H. Gotham, Maureen Redbond, Bruno Bower, and Peter Jonas. “ [The OpenScore String Quartet Corpus⁠(opens in a new window)](https://doi.org/10.1145/3625135.3625155).” Proceedings of the 10th International Conference on Digital Libraries for Musicology, pp. 49–57. ACM, 2023.[Scroll to citation 7 reference](https://openai.com/index/gpt-6-astra/#citation-top-7)

07. 8


    On FrontierCode, GPT-6 Astra was run with a developer  message similar to a [section of its developer message in Codex⁠(opens in a new window)](https://developers.openai.com/api/docs/guides/latest-model#prompting-best-practices): "Avoid creating excessive test files. Create a new test file only when required by repository conventions or when no existing file is a suitable home. Avoid unrelated cleanup and unnecessary complexity. Reuse suitable existing utilities. Read relevant repository instructions and inspect nearby code, tests, documentation, and CI. Follow established conventions. The goal is clean, mergeable code." The prompt was not optimized for the eval.[Scroll to citation 8 reference](https://openai.com/index/gpt-6-astra/#citation-top-8)

08. 9


    The first concerns how close together prime numbers can occur, however far along the number line you go. For more than a decade, the best known result established that infinitely many pairs of primes are at most 246 apart. [Julia Stadlmann⁠(opens in a new window)](https://math.illinois.edu/directory/profile/stadl) recently improved that bound to 240. Astra helped establish a stronger bound of 186, showing that infinitely many pairs occur within this smaller distance. Short prime gaps: [Proof⁠(opens in a new window)](https://cdn.openai.com/pdf/51126fac-1b68-4128-9666-c908bcc16033/short_gaps.pdf) and [supporting research⁠(opens in a new window)](https://cdn.openai.com/pdf/51126fac-1b68-4128-9666-c908bcc16033/short_gaps_abridged_cot.pdf).[Scroll to citation 9 reference](https://openai.com/index/gpt-6-astra/#citation-top-9)

09. 10


    The second concerns unusually large gaps between primes. Astra improved a term in a bound on these gaps that had remained unchanged for more than 80 years. We’re sharing the proofs and abridged chain of thought and verification materials for both results. Large prime gaps: [Proof⁠(opens in a new window)](https://cdn.openai.com/pdf/51126fac-1b68-4128-9666-c908bcc16033/long_gaps.pdf) and [supporting research⁠(opens in a new window)](https://cdn.openai.com/pdf/51126fac-1b68-4128-9666-c908bcc16033/long_gaps_abridged_cot.pdf).[Scroll to citation 10 reference](https://openai.com/index/gpt-6-astra/#citation-top-10)

10. 11


    We independently evaluated all Claude models following the intended HealthBench Professional procedure, using GPT‑5.4 grading and length-adjusted, unclipped scores. For Fable 5.1, we used Opus 5 fallback for provider refusals.[Scroll to citation 11 reference](https://openai.com/index/gpt-6-astra/#citation-top-11)

11. 12


    Claude Fable 5 and 5.1 are not included in LifeSciBench Gold v1, GeneBench Pro v13, and MedChemBench because they refuse the majority of questions in these evaluations.[Scroll to citation 12 reference](https://openai.com/index/gpt-6-astra/#citation-top-12)

12. 13


    On ExploitGym, we tested Astra and Sol without the 6-hour time limit, to better assess their full cyber capabilities. They are fast enough that it has little impact.[Scroll to citation 13 reference](https://openai.com/index/gpt-6-astra/#citation-top-13)

13. 14


    ExploitBench (June–August 2026) contains 20 high-severity V8 vulnerabilities across 13 stable Chrome releases. The benchmark tests whether agents can achieve arbitrary code execution in V8 and official Chrome releases for Linux by exploiting each specified vulnerability. Some included vulnerabilities may not permit arbitrary code execution under the evaluation’s constraints, so a 100% success rate may not be achievable.[Scroll to citation 14 reference](https://openai.com/index/gpt-6-astra/#citation-top-14)

14. 15


    Jeremy Spence et al. “ [The Next Challenge for Agentic Cybersecurity: A Realistic, Contamination-Free Reverse Engineering Benchmark⁠(opens in a new window)](https://arxiv.org/abs/2608.11469v1).” arXiv:2608.11469v1, 2026.[Scroll to citation 15 reference](https://openai.com/index/gpt-6-astra/#citation-top-15)

15. 16


    _When we test across third-party models, we use a simpler research setup. Codex has a more complex production configuration, which can result in different raw-model error rates. Provider-side safeguards and computer-tool implementations still differ. Users do not experience the no-confirmation scenario in Codex, as it's an internal research configuration._[Scroll to citation 16 reference](https://openai.com/index/gpt-6-astra/#citation-top-16)

16. 17


    For ScreenSpot-Pro and ExploitGym, the Fable scores we report come from Mythos, which is Fable with fewer safeguards.[Scroll to citation 17 reference](https://openai.com/index/gpt-6-astra/#citation-top-17)